  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">Upload your medical record to IPFS first.</p>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
        <div className="flex items-center">
          ...
          <p className="ml-3 text-sm text-blue-700">
            Your medical records are stored securely on IPFS and minted as unique tokens on the Algorand blockchain.
          </p>
        </div>
      </div>
    </div>
